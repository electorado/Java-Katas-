public class SusukiClimbsStairs20Years {
    public static void main(String[] args) {
        ...
        long result = stairsIn20(stairs);
        System.out.println("Susuki has climbed " + result + " stairs in the last 20 years.");
    }
    ...
    public static long stairsIn20(int[][] stairs)
    {
        int totalStairs = 0;
        for(int[] day : stairs){
            for (int escalones : day)
                totalStairs += escalones;
        }
